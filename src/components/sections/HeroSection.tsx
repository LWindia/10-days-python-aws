    ...
    <section className="relative min-h-screen flex flex-col items-center justify-center overflow-hidden pt-16">
      ...
      <motion.div className="relative z-10 max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 w-full py-14 lg:py-0" initial={{ opacity: 0, y: 40 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}>
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center mb-6">
          <Button variant="primary" size="lg" href="https://forms.gle/cJfAxbDd2fNxLMG39" target="_blank">Enroll Now — Free Project Based Learning <svg className="w-4 h-4" fill="none" viewBox="0 0 24 24" stroke="currentColor"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 7l5 5m0 0l-5 5m5-5H6" /></svg></Button>
        ...
        <div className="hidden sm:flex items-center justify-center gap-6 mt-10">
          <div className="flex -space-x-2">
            ...
            ].map((src, i) => (<img key={i} src={src} alt="Student" className="w-9 h-9 rounded-full border-2 border-bg-base object-cover" />))}
          </div>
          ...
          <p className="text-text-secondary text-xs"><CounterAnimation end={1200} suffix="+" increment={1} incrementInterval={2500} /> students enrolled</p>
        </div>
      </motion.div>
    </section>
  )
