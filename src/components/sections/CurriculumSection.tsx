      ...
      <div className="max-w-5xl mx-auto relative z-10">
        <AnimatedSection>
          <div className="flex flex-col items-center mb-16 text-center">
            ...
            <p className="text-text-secondary text-base sm:text-lg max-w-2xl leading-relaxed mt-4">A carefully crafted journey from <span className="text-white font-medium">"I've never coded" to "I built 5 cloud applications."</span></p>
